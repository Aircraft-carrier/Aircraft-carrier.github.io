    ...
    <el-container class="home_container">
      ...
      <el-main class="home_main">
        <el-drawer
            ...
            class="custom-drawer"
            :with-header="false">
          <el-link style="margin-top:10px; width: 100px;height: 100px" href="https://github.com/Aircraft-carrier"
                   target="_blank"
                   :underline="false">
          ...
          <el-link style="width: 100px;height: 100px" href="https://blog.csdn.net/m0_74314859" target="_blank"
                   :underline="false">
          ...
          <el-link style="width: 100px;height: 100px"
                   href="https://space.bilibili.com/661373784?spm_id_from=333.999.0.0"
                   target="_blank"
                   :underline="false">

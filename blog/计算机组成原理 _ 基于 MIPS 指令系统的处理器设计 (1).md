...
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/6003b264be174af7b2c1a93d5d0a2651.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/564f306eb45840c8bb6b0cd3c92c1884.png)
...
OP   rs   rt   immediate
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/be166ae2e175468a8b266610ebc2c3e5.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/fd61eae0be8a472498cb3fcb41b2f669.png)
...
OP   address
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b10ed6a932e7482d821633aa695e9195.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/395dbfc4e61d493bb5d1467cbac070dc.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/cb63cbad471942329a90e6eda72185e1.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5a7bbe9febd8417b9774e22881d8f949.png)


##  🍍2 指令格式的设计

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/973847a4a2f14e438c2ac8216a09c385.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/c403e76178e7437e86a4696c3054f29e.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/1329633d77a741779501f9e78a5d7a51.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7a0f66df9588480ebe2726cffdf34d77.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3bd30d163f5c4778810dfa7776ec295a.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/a59654708d3c4758a2edbabd20ebf75f.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/e4104b570b08456989ecb7037173faef.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2576ac7c8b4e46b6bbd985bfd47a35d1.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2f00ec66984d47d9875c8d861da8171e.png)

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/ec6e5d2ed5504af3851ab58b3b2a021c.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5242357ef2b447f797d7b3730943cf3f.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/9cd20781673f48c5aae0da497fb217e8.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/135258e9ffd34377b9796c37a438ff64.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/409d07c54ca840418b99a0785b521302.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/228c9230b4c54eb597e69d1229f0e64d.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b12ee2eab83440849a1dfd3fa39a1fd6.png)
...
// e.g. BEQ $t0, $t1, 16
```
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/18798381e5044201a62201406d68a960.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/426bf6402e4d4ec68356bff8a8eb468c.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/f52786b2920742c5b90da97542a78c3b.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/07cf960299854a629c468f2b11c2b628.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/4506c3e0850e4c409349d329ef9c112a.png)


一下会基于CPU基本结构框架图与前面提到的MIPS寄存器来定义指令不同阶段的微操作。由于定义的五种指令均不存在间址周期，所以将指令执行周期设置为取指、取数、执行、访存、写回五个阶段。

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/114511dcd3954ab099b8ddc7ef78f96c.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/d81aa38787844d23a62fc11df83257cf.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3ee3bbd2d4a744b7b484b327b84036be.png)
同时会结合单周期 MIPS 处理器的数据通路来分析每条指令的实际情形下的具体执行过程。辅助理解位操作。

### 3.1 ADD指令的位操作定义

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2a7547a49f2a4c308321b0f88f2b12fa.png)
...
| 微操作        |                   描述                   | 微命令       |
| ------------- | :--------------------------------------: | ------------ |
| $(PC) → MAR$  | `PC→Bus`,`Bus→MAR`,取当前指令地址`→MAR` | `PCo，MARi`  |
| $1 → R$       |                  读主存                  | `MemR=1`     |
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/8487211c264c409c88dcc715da8dc1b1.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/a58c00e6eeba4d3f906313a0c3a13cdf.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0e15aff4b0984a2a85cc6cb50524797e.png)
...
- LW指令的数据通路
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/e751bbe8e91e4af6a30b3e90ca2b4132.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/26ee6b5be7654c7eae4f3744820857f1.png)
...
| 微操作                                               | 描述                                                         | 微命令                             |
| ---------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------- |
| $(Z)→MAR、\\(R(IR[16~20]))→MDR、\\1→W、\\MDR→M(MAR)$ | 把`Z`中计算的地址送至`MAR`，并把rt寄存器中的数据送到`MDR`，把`MDR`的数据写入主存 | `Zo，MARi，Ro，MemW=1，MDRi，MDRo` |
- SW指令的数据通路
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/74cfde7debe14848b48418143ebbc9b2.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/734c7445298d4941bb072ea22041d415.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/deea39b282a7416b9ca9db6845998bab.png)
...
- 无条件跳转指令的数据通路
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/94451d722b71468b8c74a4df307d5801.png)
### 3.6 BEQ指令的位操作定义
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0869001751eb43d48e10b2cbc1cd5cc0.png)
- 有条件跳转指令的数据通路
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b91a0330e5194cd4aaeb24a9815da438.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5368915c40ce4b45b5b02ae20445c102.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3d946c2d31304d7296b296429b40a139.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/e7d7794aa8f54722b4dd1bb858451bda.png)
#### 5.1.1 CPU 中的主要寄存器
- 程序计数器
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/1bbbf53483e041219c9116b3b0420e6f.png)
...
#### 5.2.2微程序控制器组成原理
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5c53b070cbbf412d86f41139e4a8cc8b.png)
- 控制存储器
...
### 5.3 MIPS处理器的流水线设计方案
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/495650edd62d4c7a965ca7eb8414641b.png)
- 取指令
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7133b7779c224d14b1dc5b136fc9ea95.png)
- 指令译码、取操作数
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/ef95911998ed4c948fa39bcf73518b75.png)
- 执行或访存地址运算：
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/331af39339a343af82f025b3879a058e.png)
- 存储器访问
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/e9d934f4252f40b5adeb97cd521e8761.png)
- 结果写回
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/274812fb05964a1d8873884e78e5d8eb.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/a88a639a1d8e4e6d8a04fe5b6ef0614e.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/bf9708d0644649fdaa34048a60ac2c18.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/6e7036b15f9b47fb9ee515b4188890c6.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/a0b979a06a864f11a8ffddc850863d12.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/c3900ea716f44b1eb41eab1524aa7535.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/12bac8e66254459880b26a69594f5c31.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2fea60ddd3a049a38f6912baec2f39dc.png)

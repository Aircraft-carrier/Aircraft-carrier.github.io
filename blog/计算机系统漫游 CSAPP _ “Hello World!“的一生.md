![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/9e51e41373c642189570c6eb19757fea.png)
...
​	hello 的 P2P 过程是 gcc 调用 cpp(预处理器)/cc1(编译器)/as(汇编器)/ld(连接器)，将 C 语言源文件预处理、编译、汇编、链接，最终生成可执行文件保存在磁盘中，最后得以作为进程在计算机系统中运行。

![外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传](https://img-home.csdnimg.cn/images/20230724024159.png?![请添加图片描述](https://img-blog.csdnimg.cn/direct/91637de4f77b456da8f61102de2b8e99.jpeg)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7f2d1cd8d3e04a7795fc5cd4cfcee440.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0d535c6517a6451b8ef65c2a14ac270d.png)


打开生成的 hello.i 文件，发现有 3057行，并且我们原始的main代码部分被放在最后

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/602568407f3848838dbcc5b36684c1f0.png)
...
1. 外部库文件
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/64ddbf5ac4f64674a86595217c96ef11.png)


2. 数据类型名称替换

   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/ec595bfec9b648199e8f767dfabd35ba.png)
...
3. 内部函数声明
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/06a36d99df1c4a28bed8650776ae1e93.png)
...
4. 主体代码
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b3c7c5aabaa74a47a8a788ec8df19c57.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3698d5b611d64a53ad416c35c0057c6c.png)
...
1. 字符型常量
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/572ebbe569e54065b67936a59f521bad.png)


   printf 打印了一个字符串，这个字符串常量存在 .LC0 中：

   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/24e62b56a61d4127800a10b942a56a5b.png)
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/6a6bbf23fcbc44aaa1372fdbe47ee3dd.png)


   printf 打印了一个字符串，这个字符串常量存在 .LC1中

   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/d435331c4ca84f19b36ab7b6df18e13b.png)
...
2. 其他常量
   ...
   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/63a2414cbf184384b023894056bff674.png)


   它对应的汇编代码如下：
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/c9c5f67ada464859a5ac250de02b202f.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/87b3e1bee8374819ada1b8d602b4dbf1.png)


i 是在一个 for 循环语句中作为循环变量，这段代码如下：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/c1fc985cbfe14f74b6aaa1fb990564d4.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/9fcf1cc3e84442959f0ebaa6f4ab616a.png)


其中，argc 是输入的参数的个数，也就是字符串数组 argv 中的元素个数

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/37a04f02ab894e0ca1b06a4019ef1f6b.png)


找到其对应的汇编代码为：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/ae31b8fddf0e45bdbfebe870ded51ac3.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0e0fde12332d4c698c1d8cc5f827032c.png)


​	同理这个`printf`的请求也用到了`argv`数组的参数

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7e14e2937d42433b859471a829b164df.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/8ca1aea0e20a4c5faa6d304fc0939a49.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/f694b5174562446b981e56eb3e275239.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/df6a9a16ea5e4a2db5e3ece753d91601.png)


如图:

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/459d7523bfe7451cba95cd8c05a4cd7b.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b7cc96fefe734ad1bd6ebc5783e007f5.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/8a88a21f52084b9e9811e3257b18793c.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3961850432b545e1be2f4c03fcb3f986.png)


如图：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0adf2f5295314fd395885899ce7b5900.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7d4334c0e3d04541acdfb4d4c67bb040.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/72dd2e3b0dbf48eda5b20113d205ca0c.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/62db848e9cbd462e8edbad92677307a2.png)


如图：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5ffa11ec192745f8b52102513bdffa2b.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/93a3560621804381856107361d6f6050.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/281a9f43f15e4b9993e953f02b74900b.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/6163adc9b5f34649a93a85f01caa14e0.png)


如图：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7e24a07c9ac84bbfbf124e7be413638c.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/382f800837414625962c9cb882ad1a1a.png)


1. `000000003fb0`：（`Offset`）这是重定位的起始地址，即需要进行重定位的位置在文件中的偏移地址。

   ![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/2f510e988103432785a139eb82b0ed23.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/efa3bee284c4431bb5c3acb7990631d0.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3dcfc2ec3b2b468bb88034a1a5578d7d.png)


可以看到，程序的 `Type` 变成了 `EXEC (Executable file)`，程序入口也分配了地址，为 0x401190

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b33caab423364937b7d3a43402fcb60c.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/a5531d9195cd4b499d6ed31ec6b77b10.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/48279875ffe646ad9f4b71fed5663475.png)


各个节的地址也从 0 开始进行了分配。可以看到 .text 节的起始地址为 0x4010f0，刚好和main函数的地址相同。
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/34720339af3f48f581c02e1c69af93cd.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/f4709ffa3f414c9b93f5e1810c06c261.png)


与 5.3 中的节头部表进行比对，比如 .data 起始于 0x404048，查看这个内存单元

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/8d6e2a13cfc44dca9ac68558c265be27.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/c95d97851bda4e96a2470950e6671514.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/211edf5d046647cb97d99ea06c904547.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/ddf66f02b15143f3bcc9b62928d3250b.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/1a1e0d30ba1349168d1668f1a7f6a192.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/822107e010914333b9f5c5706cb1e5b8.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/835392455d41454f8486c8e76fb9eafa.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/b38756bc5bdc47eca8742b0aa2081370.png)


在运行前：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/019f2889b4c94240979f295a373bd3e6.png)


运行 dl_init 后：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/dd235d6a05c04217ab100c730dea614b.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/44abab68318341e69683587e5492c2e9.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/45d76e56a449455fa800c403fe859837.png)
...
![请添加图片描述](https://img-blog.csdnimg.cn/direct/389689bd77824481bea4cb43cec59a01.webp)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/fff13e09632642cca5521352f3ea2af9.png)


**中断：**比如在 hello 运行过程中，我们敲击键盘，那么就会触发中断，系统调用内核中的中断处理程序执行，然后返回，hello 继续执行，如图：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/44f1a01983df415b821add0e6bd99bc6.png)


**陷阱：**陷阱就是系统调用，我们的 hello 运行在用户模式下，无法直接运行内核中的程序，比如像 fork，exit 这样的系统调用。于是就通过陷阱的方式，执行 systemcall 指令，内核调用陷阱处理程序来执行系统调用，如图：

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/7f52bca765394816a00ec8ac9971d424.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/f0d3d083eb2d499c941a6c5405443c08.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/95f2820592ba4a459d7d8bcb57e5d501.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/70af7c6297b648248a601ebf573705b3.png)
**Ctrl+C**：进程收到 SIGINT 信号，结束 hello。在ps中查询不到其PID，在job中也没有显示，可以看出hello已经被彻底结束。
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/3bf4146180db45afaa7e6d88a4abb433.png)
**中途乱按**：只是将屏幕的输入缓存到缓冲区。乱码被认为是命令
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/24a152a2cbd54f71826157ecaea612df.png)
**Kill命令**：挂起的进程被终止，在ps中无法查到到其PID
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0b8c4080b7084c8b9c52650926329674.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/e045d1fc7adb4f3ea0525056f77e9901.png)


TI 位指示选择 GDT 还是 LDT，前 13 位作为索引来确定段描述符在描述符表中的位置。从段描述符和偏移地址得到线性地址的过程如图

![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/199ead83bf9c498aaabdbfb9dbfd63d0.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/5df0cc88f01f440b98a916f704d3ddb0.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/034a64a91e144d249a3f3f1b02334a21.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/da8160e4c03b46e796c8e885876ab96a.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/243a8a793cf94f87b6b099e085c975ac.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/0e257efdd24942ba9146590fb30de757.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/be5d837f7d4e4ec0ac5df3e858b3de14.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/00222f19a3e84b8e89313808bf952132.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/direct/36ebc621b68d46b0a7bfff30ce23ae2e.png)
